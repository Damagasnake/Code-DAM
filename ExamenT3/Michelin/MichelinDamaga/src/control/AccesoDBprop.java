...
public class AccesoDBprop {
	private final Properties properties = new Properties(); // mapa kv almacena datos de conexion.

	public AccesoDBprop() {
		properties.setProperty("db.url", "jdbc:sqlite:DB/GUIA_MICHELIN.db"); // URL Por defecto, se puede sobrescribir con un fichero externo.
		cargarPropiedades();
	}
