...
public class helipuertomain {
    public static void main(String[] args) {
        ...
        sc.close();
        System.out.println("El nombre de tu primer helipuerto es " + helipuerto1.getNombre());
        System.out.println("El radio de tu primer helipuerto es " + helipuerto1.getRadio());
        System.out.println("El nombre de tu segundo helipuerto es " + helipuerto2.getNombre());
        System.out.println("El radio de tu segundo helipuerto es " + helipuerto2.getRadio());
    }
}
